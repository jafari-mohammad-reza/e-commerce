...
import {GetUserDiscounts_Query, GetUserOrders_Query} from "../../graphql/Queries/GlobalQueries";
            ...
            <div className={'flex flex-col items-start justify-start space-y-12 py-10 px-20'}>
                {
                    discounts.length >1 ? discounts.map((discount) => (
                        <div key={discount._id} className={'w-max text-white   flex items-center justify-between px-10 py-7 space-x-14 bg-blue-600 rounded-3xl'}>
