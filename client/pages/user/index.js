            ...
            <div className="flex flex-col items-start justify-center w-full bg-gray-200 px-20 py-10 rounded-3xl ">
                ...
                <div className="w-full flex flex-row items-center justify-between flex-wrap">
                    <div className="flex items-center justify start-space-x-6">
                        ...
                        <span className={'text-xl md:text-2xl'}>{userDashboard?.mobileNumber ?userDashboard?.mobileNumber  : "No mobile" }</span>
                    </div>
                    <div className="flex items-center justify start-space-x-6">
                        <h3 className={'text-2xl md:text-3xl'}>Email :</h3>
                        <span className={'text-xl md:text-2xl'}>{userDashboard.email ?userDashboard.email  : "No email" }</span>
                    </div>
                    <div className="flex items-center justify start-space-x-6">
                        <h3 className={'text-2xl md:text-3xl'}>Username :</h3>
                        <span className={'text-xl md:text-2xl'}>{userDashboard.username ?userDashboard.username  : "No username" }</span>
                    </div>
                    <div className="flex items-center justify start-space-x-6">
