...
router.use('/categories',
    permissionValidator([PERMISSIONS.CONTENT_MANAGER, PERMISSIONS.ADMIN]),
    AdminCategoryRoutes);
router.use('/blogs',
    permissionValidator([PERMISSIONS.CONTENT_MANAGER, PERMISSIONS.ADMIN]),
    AdminBlogRoutes);
router.use('/products',
    permissionValidator([PERMISSIONS.CONTENT_MANAGER, PERMISSIONS.SUPPLIER,
      PERMISSIONS.ADMIN]), AdminProductRoutes);
router.use('/users',
    permissionValidator([PERMISSIONS.COUNTER, PERMISSIONS.ADMIN]),
    AdminUserRoutes);
router.use('/roles',
    permissionValidator([PERMISSIONS.SUPERADMIN]),
    AdminRoleRoutes);
